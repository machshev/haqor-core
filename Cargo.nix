...
let
  nixifiedLockHash = "0d468d12c0e982da7b90c98949e9036f1db5dcc31c577460535ddc7ff302c385";
...
in
{
  ...
  "registry+https://github.com/rust-lang/crates.io-index".async-compression."0.4.23" = overridableMkRustCrate (profileName: rec {
    name = "async-compression";
    version = "0.4.23";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b37fc50485c4f3f736a4fb14199f6d5f5ba008d7f28fe710306c92780f004c07"; };
    features = builtins.concatLists [
      [ "flate2" ]
      [ "gzip" ]
      [ "tokio" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cc."1.2.22" = overridableMkRustCrate (profileName: rec {
    name = "cc";
    version = "1.2.22";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "32db95edf998450acc7881c932f94cd9b05c87b4b2599e8bab064753da4acfd1"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap."4.5.38" = overridableMkRustCrate (profileName: rec {
    name = "clap";
    version = "4.5.38";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ed93b9805f8ba930df42c2590f05453d5ec36cbb85d018868a5b24d31f6ac000"; };
    features = builtins.concatLists [
      [ "color" ]
      [ "default" ]
      [ "derive" ]
    ...
    dependencies = {
      clap_builder = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap_builder."4.5.38" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".clap_builder."4.5.38" = overridableMkRustCrate (profileName: rec {
    name = "clap_builder";
    version = "4.5.38";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "379026ff283facf611b0ea629334361c4211d1b12ee01024eec1591133b04120"; };
    features = builtins.concatLists [
      [ "color" ]
      [ "error-context" ]
      [ "help" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".env_logger."0.11.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      jiff = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".jiff."0.2.13" { inherit profileName; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
    };
  });
  ...
  "unknown".haqor-core."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      clap = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."4.5.38" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".icu_normalizer."2.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      icu_properties = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".icu_properties."2.0.0" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".icu_properties."2.0.0" = overridableMkRustCrate (profileName: rec {
    name = "icu_properties";
    version = "2.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2549ca8c7241c82f59c80ba2a6f415d931c5b58d24fb8412caa1a1f02c49139a"; };
    features = builtins.concatLists [
      [ "compiled_data" ]
    ];
    dependencies = {
      ...
      icu_properties_data = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".icu_properties_data."2.0.0" { inherit profileName; }).out;
      icu_provider = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".icu_provider."2.0.0" { inherit profileName; }).out;
      potential_utf = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".potential_utf."0.1.2" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".icu_properties_data."2.0.0" = overridableMkRustCrate (profileName: rec {
    name = "icu_properties_data";
    version = "2.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8197e866e47b68f8f7d95249e172903bec06004b18b2937f1095d40a0c57de04"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jiff."0.2.13" = overridableMkRustCrate (profileName: rec {
    name = "jiff";
    version = "0.2.13";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f02000660d30638906021176af16b17498bd0d12813dbfe7b276d8bc7f3c0806"; };
    features = builtins.concatLists [
      [ "alloc" ]
      [ "std" ]
    ];
    dependencies = {
      ${ if false then "jiff_static" else null } = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".jiff-static."0.2.13" { profileName = "__noProfile"; }).out;
      log = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.27" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jiff-static."0.2.13" = overridableMkRustCrate (profileName: rec {
    name = "jiff-static";
    version = "0.2.13";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f3c30758ddd7188629c6713fc45d1188af4f44c90582311d0c8d8c9907f60c48"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.14" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.vendor.name == "apple") then "openssl_sys" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.108" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.72" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ffi = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.108" { inherit profileName; }).out;
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.108" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      cc = (buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.2.22" { profileName = "__noProfile"; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.12.15" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if !(hostPlatform.parsed.cpu.name == "wasm32") then "async_compression" else null } = (rustPackages."registry+https://github.com/rust-lang/crates.io-index".async-compression."0.4.23" { inherit profileName; }).out;
  ...
  "registry+https://github.com/rust-lang/crates.io-index".sqlite."0.36.2" = overridableMkRustCrate (profileName: rec {
    ...
    version = "0.36.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6843ff5d46230ca95be07e59876757d7c4dd88f5204eeede7271dab03ac4bed3"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "linkage" ]
    ];
